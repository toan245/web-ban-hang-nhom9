<%@ Page Title="" Language="C#" MasterPageFile="~/BaiTapLon.master" AutoEventWireup="true" CodeFile="DHCasioNamMTP-V004G.aspx.cs" Inherits="DHCasioNamMTP_V004G" %>
    ...
    <table class="content2">
        <tr>
            <td Height="400px" Width="400px">
                <asp:Image ID="Image1" runat="server" ImageUrl="~/donghonamcasiomtp.jpg" Height="400px" Width="400px" />
            </td>
            <td Height="400px" class="auto-style1"><h2 style="color:gray;">CASIO</h2>
                <h3><asp:Label ID="lbTensp" runat="server" Text="Đồng Hồ Casio Nam MTP-V004G-7B2UDF Dây Thép Không Gỉ 47mm"></asp:Label></h3>
                <h3 style="color:gray;"><asp:Label ID="lbMasp" runat="server" Text="SKU:MTP-V004G-7B2UDF"></asp:Label></h3>
                <p>Giá cũ:<strike>1.119.000VNĐ</strike></p>
                <p>Giá mới:<strong style="font-size:40px;color:red;"><asp:Label ID="lbGia" runat="server" Text="1.119.000VNĐ"></asp:Label></strong></p>
