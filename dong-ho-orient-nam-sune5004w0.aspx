<%@ Page Title="" Language="C#" MasterPageFile="~/BaiTapLon.master" AutoEventWireup="true" CodeFile="dong-ho-orient-nam-sune5004w0.aspx.cs" Inherits="dong_ho_orient_nam_sune5004w0" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="MenuRight">
    <div class="menubar1">
        <asp:Menu ID="Menu1" runat="server" CssClass="aspMenu2" Orientation="Horizontal" StaticEnableDefaultPopOutImage="False">
            <Items>
    ...
    <table class="content2">
        <tr>
            <td Height="400px" Width="400px">
                <asp:Image ID="Image1" runat="server" Height="400" Width="400" ImageUrl="~/DongHoCasio/2.jpg" />
            </td>
            <td Height="400px" class="auto-style1"><h2 style="color:gray;">CASIO</h2>
                <h3><asp:Label ID="lbTensp" runat="server" Text="Đồng Hồ Nữ Casio Sheen SHE-3033GL-7AUDR Dây"></asp:Label></h3>
                <h3 style="color:gray;"><asp:Label ID="lbMasp" runat="server" Text="SKU:SHE-3033GL-7AUDR"></asp:Label></h3>
                <p>Giá cũ:<strike>1.119.000VNĐ</strike></p>
                <p>Giá mới:<strong style="font-size:40px;color:red;"><asp:Label ID="lbGia" runat="server" Text="5.119.000VNĐ"></asp:Label></strong></p>
